...
- `memory_console`, `project_memory_index`, and `session_context` now surface recent inbox notes separately from handoffs, so workbench views can show real cross-device notes without muddying continuity state
